...
public abstract class AbstractModel<T> {
	...
	protected static final SessionFactory sessionFactory = HibernateUtil
			.getSessionFactory();
	...
	public T findByExample(Object instance) {
		try {
			if (!sessionFactory.getCurrentSession().getTransaction().isActive())
				sessionFactory.getCurrentSession().getTransaction().begin();     
			T results =  (T) sessionFactory.getCurrentSession().createCriteria(entityClass).add(
